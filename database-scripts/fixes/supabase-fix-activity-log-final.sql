-- =====================================================
-- CORREÇÃO FINAL DA FUNÇÃO LOG_TICKET_ACTIVITY
...
-- 4. Remover política existente se houver e criar nova
DROP POLICY IF EXISTS "Users can view activity logs for accessible tickets" ON public.ticket_activity_logs;
...
SELECT 'Função log_ticket_activity criada e sistema de logs operacional!' as status; 