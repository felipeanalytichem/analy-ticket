...
export const AppLayout = ({ children, title, showSearch = true, onSearch }: AppLayoutProps) => {
  ...
  const getActiveTabFromPath = (pathname: string): string => {
    const pathMap: Record<string, string> = {
      ...
      '/tickets/all-agents': 'all-agent-tickets',
      ...
      '/admin/sla-notifications': 'sla-notifications',
      '/admin/session-timeout': 'session-timeout-config',
      '/admin/workload': 'workload-dashboard',
      '/admin/assignment-rules': 'assignment-rules',
      '/admin/category-expertise': 'category-expertise',
      '/debug': 'debug',
  ...
  const handleTabChange = (tab: string) => {
    const tabRoutes: Record<string, string> = {
      ...
      'all-agent-tickets': '/tickets/all-agents',
      'agent-dashboard': '/agent-dashboard',
      'analytics': '/analytics',
      'reports': '/reports',
      'knowledge': '/knowledge',
      ...
      'sla-notifications': '/admin/sla-notifications',
      'session-timeout-config': '/admin/session-timeout',
      'workload-dashboard': '/admin/workload',
      'assignment-rules': '/admin/assignment-rules',
      'category-expertise': '/admin/category-expertise',
      'debug': '/debug',
      'settings': '/settings',
      'profile': '/profile',
      'notifications': '/notifications',
  ...
  const getPageTitle = () => {
    ...
    const routeTitles: Record<string, string> = {
      ...
      'all-agent-tickets': 'All Agent Tickets',
      'agent-dashboard': 'Agent Dashboard',
      'analytics': 'Analytics',
      'reports': 'Reports',
